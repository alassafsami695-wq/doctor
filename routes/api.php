...
use App\Http\Controllers\Api\DoctorCodeController;
...
// ❌ تم حذف verify-code و resend-code
...
Route::middleware(['auth:sanctum', 'check.subscription'])->group(function () {
    ...
    Route::prefix('doctor/partners')->group(function () {
        ...
        Route::post('/{id}/logs', [PartnerController::class, 'storeLog']);
    });
    ...
    Route::post('/lab-orders/{id}', [LabOrderController::class, 'update']);
...
Route::middleware(['auth:sanctum', 'is.superadmin'])->group(function () {
    ...
    // ✅ مسارات إدارة رموز التسجيل
    Route::get('/admin/doctor-codes', [DoctorCodeController::class, 'index']);
    Route::post('/admin/doctor-codes', [DoctorCodeController::class, 'store']);
    Route::delete('/admin/doctor-codes/{id}', [DoctorCodeController::class, 'destroy']);
});